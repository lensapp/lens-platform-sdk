...
describe("UserService", () => {
  ...
  describe("updateOne", () => {
    ...
    it("throws UsernameAlreadyExistsException when trying to change username to existing user's", async done => {
      return expect(await bobPlatform.client.user.updateOne(userBob.username, {
