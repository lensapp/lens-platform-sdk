...
import type { Business, BusinessSubscription, BusinessInvitation, UserBusinessRole, BusinessInvitationState, BusinessUsers } from "./BusinessService";
...
export type {
  ...
  BillingInfo, Business, BusinessSubscription, BusinessInvitation, UserBusinessRole, BusinessInvitationState, BusinessUsers,
};
