 ...
 * {1,13}: This quantifier ensures that there are between 1 and 13 of the previous character set.
 ...
 */
export const businessHandleValidation = /^(?!-)[A-Za-z0-9-]{1,13}[A-Za-z0-9](?<!-)$/;
